...
def merge_datasets(start_date, dem_image, daymet_lat_lon, pm_df):
    ...
    merge_xr.to_netcdf(path=f'/media/zhongying/WD_BLACK/PM2.5_CONUS_LSTM/data/merged_inputs/{start_date}_wo_imputation.nc',
                       mode='w',
...
if __name__ == "__main__":
    ...
    while start_date < end_date:
        ...
        if os.path.isfile(f'/media/zhongying/WD_BLACK/PM2.5_CONUS_LSTM/data/merged_inputs/{start_date}_wo_imputation.nc'):
